...
function criarBotoes() {
    ...
    targetY += 75;
    botoes.push({ x: targetX, y: targetY, width: 150, height: 50, texto: 'Regras', cor: '#28A745', corBotao: '#1E7E34', hoverCor: '#28A745', action: () => { window.location.href = './game.html#regras'; }})
    targetY += 75;
    botoes.push({ x: targetX, y: targetY, width: 150, height: 50, texto: 'Voltar', cor: '#6C757D', corBotao: '#495057', hoverCor: '#6C757D', action: () => { window.location.href = './index.html';}})
}
