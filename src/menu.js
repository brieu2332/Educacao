...
const botoes = [
    { x: 250, y: 300, width: 150, height: 50, texto: 'Voltar', corBotao: 'orange', link: '/public/index.html' },
    { x: 450, y: 300, width: 150, height: 50, texto: 'Continuar', corBotao: 'green', link: '/public/game.html' },
